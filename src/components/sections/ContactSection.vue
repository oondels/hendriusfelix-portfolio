...
const contactInfo = [
  {
    ...
    label: 'Email',
    value: 'hendrius.felix@email.com',
    link: 'mailto:hendrius.felix@email.com'
  },
  {
...
const socialLinks = [
  {
    ...
    label: 'LinkedIn',
    link: 'https://linkedin.com/in/hendrius'
  },
  {
    ...
    label: 'GitHub',
    link: 'https://github.com/hendrius'
  }
];
</script>
